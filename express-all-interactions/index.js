...
const SLACK_SIGNING_SECRET = '3964517d222608f49353e7b4f44d5c66';
const SLACK_CLIENT_ID = '644992008773.633612357650';
const SLACK_CLIENT_SECRET = '5648a8a3453f3fefb8b3a8df301d1f4c';
const SLACK_ACCESS_TOKEN = 'tJfimaFbgWl9t5m0sSH2Qxu3';

// Read the signing secret and access token from the environment variables
const slackSigningSecret = SLACK_SIGNING_SECRET;
const slackAccessToken = SLACK_ACCESS_TOKEN;
